This fix is for 1.1.4 ONLY, not by intention, just given that this is an area of code that's actively changing.  I'll attempt to update it as changes are made.

This is kludgy; don't expect much...

My main goal was simply to get the [hello world tutorial](https://developers.eos.io/eosio-cpp/docs/hello-world) on the [EOS Developer Portal](https://developers.eos.io/) working.  This script and one other mod achieves that.
